...
//    @Binding var isTargetReached: Bool
    ...
    var body: some View {
        NavigationStack {
//            VStack(spacing: 15) {
//                DatePicker("Sleep Time", selection: $alarm.sleepTime, displayedComponents: .hourAndMinute)
//            }
        }
        .onAppear {
            viewModel.delegate()
//            if viewModel.isTargetReached == true {
